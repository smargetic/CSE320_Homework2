...
#include "datadef.h"
#include "choices.h"
//need to edit va_start, end, etc. with this
//#include "menu.h"
...
{
  int rval;
  rval = rolo_menu_yes_no ( //changed this from menu_yes
...
int add_the_entry ()
{
  return(MENU_YES == rolo_menu_yes_no ( //changed this from menu_yes
...

{
  ...
  //, *datum; <-- other variable, was being unused tho
  Ptr_Rolo_List rlink;
...
{
  //printf("\nGOES HEREE\n")
  static int entry_menu_displayed = 0; //"static entry_menu_displayed"
  int rval,menuval;
  char *response;
  //printf("\nGOES HERE");
